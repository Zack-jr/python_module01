...
plants_list = [("Rose", 25, 30), ("Oak", 200, 365), ("Cactus", 5, 90), ("Sunflower", 80, 45), ("Fern", 15, 120)]
count = 0
for i in plants_list:
    element = plant(*i)
    print(f'Created: {element.plant_name} ({element.plant_height}cm, {element.plant_age} days)')
    count += 1
